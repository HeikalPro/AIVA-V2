...
from llm_service.config.provider_config import OpenRouterProviderConfig
...
class OpenRouterProvider(BaseHTTPProvider):
    ...
    def __init__(self, config: OpenRouterProviderConfig) -> None:
        ...
        self._client.headers.setdefault("HTTP-Referer", "https://github.com/llm-service")
        self._client.headers.setdefault("X-Title", "llm-service")
