...
_READ_ROLES = (ROLE_SUPER_ADMIN, ROLE_ORG_ADMIN, ROLE_ACCOUNT_MANAGER, ROLE_DEVELOPER, ROLE_SUPERVISOR)


@router.get("", response_model=list[CorpusSummaryOut])
async def list_corpora(
    _user: Annotated[UserContext, Depends(require_roles_or_nav_permission("ingestion", *_READ_ROLES))],
